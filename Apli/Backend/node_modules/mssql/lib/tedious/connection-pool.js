...
class ConnectionPool extends BaseConnectionPool {
  _poolCreate () {
    return new shared.Promise((resolve, reject) => {
      ...
      cfg.options.connectTimeout = this.config.connectionTimeout || this.config.timeout || 55000
      cfg.options.requestTimeout = this.config.requestTimeout != null ? this.config.requestTimeout : 55000
      ...
      if (isNaN(cfg.options.requestTimeout)) cfg.options.requestTimeout = 55000
